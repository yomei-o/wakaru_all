...
### 🔎 姉妹シリーズ「物理を作る 第2部 ── その数は、偶然か」

第1部は「空白に道具を作って走らせる」シリーズで、全19話・新しい物理は0でした。第2部は標的を変えます ── **世の中にすでにある「妙にきれいな数」を、偶然かどうか裁く。**

第1回は **Koide 関係**（荷電レプトンの質量が満たす、45年間導出されていない式）。帰無モデル4通りとも $p\sim10^{-5}$ ですが、**その $p$ は間違った問いの答え**でした（同じ族を乱数に当てると 51% で何かが当たる）。決めたのは統計ではなく年表 ── **1981年に 2.26σ 外れていた予言に、データが 7.3 MeV 寄っていった。**

👉 https://yomei-o.github.io/wakaru_all/butsuri-tsukuru2/index.html
