...
| シリーズ | 内容 | 読む（公開サイト）|
|---|---|---|
| **わかる共形変換**〔※「わかる宇宙論」続編〕| 物差しを場所ごとに取り替えると、宇宙はどこまで書き換わるか。膨張は原子が縮んでいるだけかもしれない（全10話・完結＋番外1） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-kyokei/index.html) |
...
| **考える波**〔※新シリーズ・**継続中**〕| 音声を微分すると高音、積分すると低音 ── ならば物理定数はすべて何かの積分値ではないか。その一行から歩き出して「階数」に行き着く（全28話・11部構成・継続中） | [開く](https://yomei-o.github.io/wakaru_all/kangaeru-nami/index.html)／[English](https://yomei-o.github.io/wakaru_all/kangaeru-nami-en/index.html) |
...
| **わかるブラックホール** | 立方体の対角線（c・ℏ・G）を、情報とビットで読む。地平面・エントロピー＝ビット・ホログラフィ（全6話・完結＋番外） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-blackhole/index.html) |
| **わかる繰り込み** | 世界はなぜ〈捨てても〉成り立つのか。粗視化・デコヒーレンス・普遍性・繰り込み群・階層問題（全7話・完結＋番外） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-kurikomi/index.html) |
| **わかる温度** | 温度は物質の性質ではない。k_B は両替レート。負の温度・虚時間の周期・ウンルー効果（全7話・完結＋番外） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-ondo/index.html) |
| **わかるすり抜け** | 越えられない壁を、越えずに向こう側へ。虚時間の中を歩く・太陽が燃える理由・真空崩壊（全7話・完結＋番外） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-surinuke/index.html) |
| **わかる屈折** | 屈折で光が遅くなるのに、なぜ光速不変は破れないのか。位相速度は c を超える・屈折と吸収は同じ関数（全7話・完結） | [開く](https://yomei-o.github.io/wakaru_all/wakaru-kussetsu/index.html) |
| **つくる格子**〔※作る側〕| 唯一「わかる」ではなく**つくる**シリーズ。空白に道具を作って走らせ、平坦な格子で水星を回す（42.9807″/世紀。全19話＋番外4話・完結） | [開く](https://yomei-o.github.io/wakaru_all/butsuri-tsukuru/index.html) |
