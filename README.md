...
| `wakaru-uchu-keisanki/` | **宇宙は計算機** ── 宇宙を計算の視点で読む | [index](wakaru-uchu-keisanki/uchu-keisanki-index.html) |
| `wakaru_learn/` | **わかる学習論** ── 進化・学習・意識を、ひとつの勾配で読む | [index](wakaru_learn/index.html) |
| `wakaru-unix/` | **わかるUNIXの歴史** | [index](wakaru-unix/index.html) |

## 読み方
各フォルダの目次ページ（多くは `index.html`）から各話へ。個々の HTML はブラウザで開くだけで動きます。印刷は各ページの「印刷 → PDF に保存」から。
